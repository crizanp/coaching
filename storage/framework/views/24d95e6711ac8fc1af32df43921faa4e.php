...
<?php $__env->startSection('title', __('messages.about.page.title')); ?>
<?php $__env->startSection('description', __('messages.about.page.description')); ?>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="fade-in">
                    ...
                    <p class="lead mb-4"><?php echo e(__('messages.about.hero.subtitle')); ?></p>
            ...
            <div class="col-lg-8">
                <div class="fade-in text-start">
                    ...
                    <div class="about-content">
                        ...
                        <p><?php echo e(__('messages.about.story.journey')); ?></p>
                        <p><?php echo e(__('messages.about.story.discovery')); ?></p>
                        <p><?php echo e(__('messages.about.story.mission')); ?></p>
                        <p><?php echo e(__('messages.about.story.approach')); ?></p>
                        <p><?php echo e(__('messages.about.story.today')); ?></p>
                    </div>
                    ...
                    <div class="contact-cta mt-5">
                        ...
                        <div class="d-flex justify-content-start gap-3 flex-wrap mt-3">
                            <a href="<?php echo e(route('contact.index', app()->getLocale())); ?>" class="btn btn-primary">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="fade-in mb-5">
                    <h2 class="section-title text-center"style="color: #000000ff;"><?php echo e(__('messages.about.practices.title')); ?></h2>
                    <p class="section-subtitle text-left"><?php echo e(__('messages.about.practices.subtitle')); ?></p>
                </div>
            </div>
        </div>
                ...
                <div class="practice-card-textured h-100">
                    <div class="practice-card-body">
                        ...
                        <div class="practice-card-content">
                            <h4><?php echo e(__('messages.about.practices.sophrology.title')); ?></h4>
                        </div>
                    </div>
                    <blockquote class="practice-quote-textured">
                        <em>"<?php echo e(__('messages.about.practices.sophrology.quote')); ?>"</em>
                    </blockquote>
                </div>
            </div>
            ...
            <div class="col-lg-4 mb-4">
                <div class="practice-card-textured h-100">
                    <div class="practice-card-body">
                        ...
                        <div class="practice-card-content">
                            <h4><?php echo e(__('messages.about.practices.nlp.title')); ?></h4>
                        </div>
                    </div>
                    <blockquote class="practice-quote-textured">
                        <em>"<?php echo e(__('messages.about.practices.nlp.quote')); ?>"</em>
                    </blockquote>
                </div>
            </div>
            ...
            <div class="col-lg-4 mb-4">
                <div class="practice-card-textured h-100">
                    <div class="practice-card-body">
                        ...
                        <div class="practice-card-content">
                            <h4><?php echo e(__('messages.about.practices.hypnosis.title')); ?></h4>
                        </div>
                    </div>
                    <blockquote class="practice-quote-textured">
                        <em>"<?php echo e(__('messages.about.practices.hypnosis.quote')); ?>"</em>
                    </blockquote>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-lg-8 mb-5">
                <div class="fade-in">
                    <h2 class="section-title text-white"><?php echo e(__('messages.about.stats.title')); ?></h2>
                    <p class="text-white opacity-90"><?php echo e(__('messages.about.stats.subtitle')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="stats-card fade-in">
                    ...
                    <div class="stats-label"><?php echo e(__('messages.about.stats.experience')); ?></div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="stats-card fade-in">
                    <div class="stats-number">100+</div>
                    <div class="stats-label"><?php echo e(__('messages.about.stats.clients')); ?></div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="stats-card fade-in">
                    <div class="stats-number">3</div>
                    <div class="stats-label"><?php echo e(__('messages.about.stats.methods')); ?></div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="stats-card fade-in">
                    <div class="stats-number">95%</div>
                    <div class="stats-label"><?php echo e(__('messages.about.stats.satisfaction')); ?></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-8">
                    <div class="cta-buttons">
                        <a href="<?php echo e(route('booking.index', app()->getLocale())); ?>" class="btn btn-primary btn-lg me-3 mb-3">
                            <i class="fas fa-calendar-check me-2"></i><?php echo e(__('messages.about.cta.book')); ?>

                        </a>
                        <a href="<?php echo e(route('services.index', app()->getLocale())); ?>" class="btn btn-outline-primary btn-lg mb-3">
                            <i class="fas fa-info-circle me-2"></i><?php echo e(__('messages.about.cta.services')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\client-fiverr\coaching\resources\views/about.blade.php ENDPATH**/ ?>