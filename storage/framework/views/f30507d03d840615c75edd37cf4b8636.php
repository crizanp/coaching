...
<body>
    ...
    <div class="admin-sidebar" id="adminSidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <div class="nav-item">
                    <a href="<?php echo e(route('admin.contact-messages.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.contact-messages.*') ? 'active' : ''); ?>">
    ...
    <div class="admin-main" id="adminMain">
        ...
        <footer class="admin-footer">
            <span>&copy; <?php echo e(now()->year); ?> <?php echo e(config('ssjchrysalide', 'ssjchrysalide')); ?>. All rights reserved.</span>
            <div class="footer-links">
                <?php if($adminContactEmail): ?>
                    <a href="mailto:<?php echo e($adminContactEmail); ?>"><i class="fas fa-envelope me-1"></i><?php echo e($adminContactEmail); ?></a>
                <?php endif; ?>
                <?php if($adminContactPhone): ?>
                    <a href="tel:<?php echo e($adminContactPhoneHref); ?>"><i class="fas fa-phone me-1"></i><?php echo e($adminContactPhone); ?></a>
                <?php endif; ?>
            </div>
        </footer>
    </div>
