                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div id="benefits_fr_container">
                                    <?php $benefits_fr = old('benefits_fr', $service->getTranslation('benefits', 'fr') ?? []); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="benefits_en_container">
                                    <?php $benefits_en = old('benefits_en', $service->getTranslation('benefits', 'en') ?? []); ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div id="session_format_fr_container">
                                    <?php $session_format_fr = old('session_format_fr', $service->getTranslation('session_format', 'fr') ?? []); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="session_format_en_container">
                                    <?php $session_format_en = old('session_format_en', $service->getTranslation('session_format', 'en') ?? []); ?>
