...
<?php $__env->startSection('page-title', $isEdit ? 'Edit Event' : 'Create Event'); ?>
...
<div class="fade-in">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-1"><?php echo e($isEdit ? 'Edit Event' : 'Create New Event'); ?></h2>
            <p class="text-muted"><?php echo e($isEdit ? 'Update event details' : 'Create a new workshop or event'); ?></p>
        </div>
    ...
    <form method="POST" action="<?php echo e($isEdit ? route('admin.events.update', $event) : route('admin.events.store')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                    value="<?php echo e(old('title.fr', $isEdit ? $event->getTranslation('title', 'fr') : '')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                    value="<?php echo e(old('title.en', $isEdit ? $event->getTranslation('title', 'en') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>" required><?php echo e(old('description.fr', $isEdit ? $event->getTranslation('description', 'fr') : '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('description.en', $isEdit ? $event->getTranslation('description', 'en') : '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <textarea id="content_fr" name="content[fr]" rows="6" class="form-control <?php $__errorArgs = ['content.fr'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required><?php echo e(old('content.fr', $isEdit ? $event->getTranslation('content', 'fr') : 'Un atelier riche en découvertes où chacun repartira avec les clés pour :
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea id="content_en" name="content[en]" rows="6" class="form-control <?php $__errorArgs = ['content.en'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('content.en', $isEdit ? $event->getTranslation('content', 'en') : '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>">
                                <option value="workshop" <?php echo e(old('type', $isEdit ? $event->type : 'workshop') === 'workshop' ? 'selected' : ''); ?>>Workshop</option>
                                <option value="practical" <?php echo e(old('type', $isEdit ? $event->type : '') === 'practical' ? 'selected' : ''); ?>>Practical</option>
                                <option value="online" <?php echo e(old('type', $isEdit ? $event->type : '') === 'online' ? 'selected' : ''); ?>>Online</option>
                                <option value="hybrid" <?php echo e(old('type', $isEdit ? $event->type : '') === 'hybrid' ? 'selected' : ''); ?>>Hybrid</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" 
                    value="<?php echo e(old('event_date', optional(optional($event)->event_date)->format('Y-m-d\TH:i'))); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                    value="<?php echo e(old('registration_deadline', optional(optional($event)->registration_deadline)->format('Y-m-d\TH:i'))); ?>">
            ...
            <div class="col-lg-4">
                ...
                <div class="admin-card mb-4">
                    ...
                    <div class="text-center">
                        <?php if($isEdit && $event->featured_image): ?>
...
<script>
    ...
    if (titleInput && !<?php echo e($isEdit ? 'true' : 'false'); ?>) {
