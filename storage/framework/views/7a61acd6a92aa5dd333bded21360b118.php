...
<div class="fade-in">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('admin.blogs.create')); ?>" class="btn-admin btn-admin-primary">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3">
            <div class="stat-card success">
                ...
                <div class="stat-value"><?php echo e($blogs->where('is_published', true)->count()); ?></div>
        ...
        <div class="col-md-3">
            <div class="stat-card warning">
                ...
                <div class="stat-value"><?php echo e($blogs->where('is_published', false)->count()); ?></div>
        ...
        <div class="col-md-3">
            <div class="stat-card info">
                ...
                <div class="stat-value"><?php echo e(number_format($blogs->sum('views_count'))); ?></div>
    ...
    <div class="admin-card mb-4">
        <form method="GET" class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="search" class="form-control" placeholder="Search posts..." value="<?php echo e(request('search')); ?>">
            </div>
            <div class="col-md-2">
            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" class="blog-checkbox" value="<?php echo e($blog->id); ?>">
                            </td>
                            <td>
                            ...
                            <td>
                                <span class="badge badge-<?php echo e($blog->is_published ? 'success' : 'warning'); ?>">
                            ...
                            <td>
                                <?php if($blog->published_at): ?>
                                    <?php echo e($blog->published_at->format('d/m/Y H:i')); ?>
                            ...
                            <td>
                                <div class="text-center">
                                    <strong><?php echo e(number_format($blog->views_count)); ?></strong>
                                    <br>
                                    <small class="text-muted">
                                        <i class="fas fa-thumbs-up"></i> <?php echo e($blog->likes_count); ?>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    ...
                                    <form method="POST" action="<?php echo e(route('admin.blogs.toggle-publish', $blog)); ?>" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PATCH'); ?>
                                        <button type="submit"
                                                class="btn-admin btn-admin-<?php echo e($blog->is_published ? 'warning' : 'success'); ?> btn-sm"
