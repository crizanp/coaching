...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title><?php echo $__env->yieldContent('title', (\App\Models\Setting::get('site_name')[app()->getLocale()] ?? 'SSJCHRYSALIDE') . ' - ' . (\App\Models\Setting::get('site_tagline')[app()->getLocale()] ?? 'Thérapie Brève Martinique')); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('description', \App\Models\Setting::get('site_tagline')[app()->getLocale()] ?? 'Accompagner les personnes qui traversent des périodes de stress, de fatigue émotionnelle, de troubles du sommeil, de blocages personnels, ou qui souhaitent simplement opérer des changements et atteindre de nouveaux objectifs.'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('keywords', __('sophrologie, PNL, hypnose, thérapie brève, Martinique, stress, blocages, développement personnel')); ?>">
    ...
    <?php if(app()->getLocale() == 'fr'): ?>
        <link rel="alternate" hreflang="en" href="<?php echo e(url()->current()); ?>?lang=en">
        <link rel="alternate" hreflang="fr" href="<?php echo e(url()->current()); ?>?lang=fr">
    <?php else: ?>
        <link rel="alternate" hreflang="fr" href="<?php echo e(url()->current()); ?>?lang=fr">
        <link rel="alternate" hreflang="en" href="<?php echo e(url()->current()); ?>?lang=en">
    <?php endif; ?>
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('og:title', \App\Models\Setting::get('site_name')[app()->getLocale()] ?? 'SSJCHRYSALIDE'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('og:description', \App\Models\Setting::get('site_tagline')[app()->getLocale()] ?? 'Thérapie Brève en Martinique'); ?>">
    <meta property="og:type" content="<?php echo $__env->yieldContent('og:type', 'website'); ?>">
    <meta property="og:url" content="<?php echo e(url()->current()); ?>">
    <meta property="og:image" content="<?php echo $__env->yieldContent('og:image', asset('images/og-image.jpg')); ?>">
    ...
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('twitter:title', \App\Models\Setting::get('site_name')[app()->getLocale()] ?? 'SSJCHRYSALIDE'); ?>">
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('twitter:description', \App\Models\Setting::get('site_tagline')[app()->getLocale()] ?? 'Thérapie Brève en Martinique'); ?>">
    <meta name="twitter:image" content="<?php echo $__env->yieldContent('twitter:image', asset('images/og-image.jpg')); ?>">
...
<body class="<?php if(auth()->guard()->check()): ?> admin-theme <?php endif; ?>">
    <div id="app">
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
            <div class="container-fluid">
                <a class="navbar-brand d-flex align-items-center" href="<?php if(auth()->guard()->check()): ?> <?php echo e(route('admin.dashboard')); ?> <?php else: ?> <?php echo e(url('/')); ?> <?php endif; ?>">
                    <img src="<?php echo e(asset('images/assets/SSJchrysalis-first.png')); ?>" alt="SSJ Symbol" class="navbar-logo-symbol me-2">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="adminDropdown">
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.dashboard')); ?>"><i class="fas fa-dashboard"></i> Dashboard</a></li>
                                    ...
                                    <li><a class="dropdown-item" href="<?php echo e(url('/fr')); ?>" target="_blank"><i class="fas fa-external-link-alt"></i> View Site</a></li>
                                </ul>
                            </li>
                        <?php endif; ?>
                    </ul>
