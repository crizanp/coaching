            ...
            <div class="col-lg-4 fade-in">
                <div class="practice-card-textured sticky-top" style="top: 100px;">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <strong><?php echo e(__('messages.services.price_group')); ?>:</strong><br>
                            <span class="h5 text-primary"><?php echo e(number_format($service->price_group, 0)); ?>€</span>
                        </div>
                        <?php endif; ?>
                        
                        <?php if($service->duration): ?>
                        <div class="mb-4">
                            <strong><?php echo e(__('messages.services.duration')); ?>:</strong><br>
