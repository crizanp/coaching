                ...
                <div class="col-lg-10">
                    <div class="past-event-card mb-4 fade-in position-relative">
                        <div class="past-event-photo" aria-hidden="true">
                            <img src="{{ asset('images/assets/julyworkshop.png') }}" alt="July Workshop" class="img-fluid">
                            <div class="price-badge">20€</div>
                        </div>

                        <div class="past-event-body text-center">
                            <div class="past-event-meta">
                                <div class="past-event-title">{{ __('messages.events.past.title') }}</div>
                                <div class="past-event-sub">{{ __('messages.events.past.subtitle') }}</div>
                            </div>

                            <ul class="past-event-list mx-auto" style="max-width:640px;">
                                <li>{{ __('messages.events.past.intro') }}</li>
                                <li>– {{ __('messages.events.past.benefit1') }}</li>
                                <li>– {{ __('messages.events.past.benefit2') }}</li>
                                <li>– {{ __('messages.events.past.benefit3') }}</li>
                            </ul>

                            <div class="past-event-cta d-flex justify-content-center gap-2">
                                <button type="button" class="btn btn-outline-primary btn-sm vvv-open-detail">{{ __('messages.events.past.detail_button') }}</button>
                                <a href="{{ route('contact.index', app()->getLocale()) }}" class="btn btn-primary btn-sm">{{ __('messages.events.contact_us') }}</a>
                            </div>

                            <div class="past-event-note mt-3 text-success">{{ __('messages.events.past.note_completed') }}</div>
                        </div>

                        <div class="past-event-mark">{{ __('messages.events.past.past_mark') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="vvv-modal-panel" role="dialog" aria-modal="true" aria-labelledby="vvv-modal-title">
                ...
                <div class="vvv-modal-grid">
                    <div class="vvv-modal-image">
                        <img src="{{ asset('images/assets/julyworkshop.png') }}" alt="event image" id="vvv-modal-image">
                        <div class="vvv-modal-price" id="vvv-modal-price">20€</div>
                    </div>
                    <div class="vvv-modal-content text-left">
                        <h3 id="vvv-modal-title">{{ __('messages.events.past.title') }}</h3>
                        <p class="text-muted mb-3" id="vvv-modal-sub">{{ __('messages.events.past.subtitle') }}</p>

                        <div id="vvv-modal-description">
                            <p>{{ __('messages.events.past.intro') }}</p>
                            ...
                            <p class="text-success"><strong>{{ __('messages.events.past.note_completed') }}</strong></p>
                            <p>{{ __('messages.events.past.more_info') }}</p>
                        </div>

                        <div class="vvv-modal-actions">
                            <a href="{{ route('contact.index', app()->getLocale()) }}" class="btn btn-primary me-2">{{ __('messages.events.contact_us') }}</a>
                            <button class="btn btn-outline-secondary" data-close>{{ __('messages.common.close') }}</button>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-4 mb-4">
                                <div class="practice-card-textured h-100">
                                    ...
                                    <p class="service-description mb-4">
                                        {{ Str::limit($event->getLocalizedTranslation('description', app()->getLocale()), 100) }}
                                    </p>

                                    <div class="service-details mb-4">
                                        @if($event->event_date)
                                            <div class="service-detail-item mb-2">
                                                <strong>{{ __('messages.events.date') }}:</strong>
                                        ...
                                        @if($event->max_participants)
                                            <div class="service-detail-item mb-2">
                                                <strong>{{ __('messages.events.spots_available') }}:</strong>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="text-center fade-in">
                                ...
                                <a href="{{ route('contact.index', app()->getLocale()) }}" class="btn btn-primary btn-lg">
                        ...
                        @foreach($activeWorkshops as $event)
                            <div class="col-lg-6 mb-4">
                                <div class="practice-card-textured h-100">
                                    ...
                                    <p class="service-description mb-4">
                                        {{ $event->getLocalizedTranslation('description', app()->getLocale()) }}</p>
